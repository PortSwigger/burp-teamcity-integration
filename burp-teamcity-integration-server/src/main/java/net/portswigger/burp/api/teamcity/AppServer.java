...
public class AppServer
{
    ...
    private static class BurpScan extends RunType
    {
        ...
        public Map<String, String> getDefaultRunnerProperties()
        {
            ...
            properties.put(BURP_SCAN_PROPERTY_TIMEOUT, BURP_SCAN_PROPERTY_TIMEOUT_EMPTY);
            properties.put(BURP_SCAN_PROPERTY_SELF_SIGNED_CERT_X509, BURP_SCAN_PROPERTY_SELF_SIGNED_CERT_X509_EMPTY);
